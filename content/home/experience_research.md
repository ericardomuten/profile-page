...
1. Quantum Technology & Application Consortium (QUTAC)&#58;<br>
- Presented the idea of QRR-enhanced QAOA and its use cases in solving the knapsack problem.<br>
2. Quantum-enabling Services and Tools for Industrial Applications (QuaST)&#58;<br>
- Conducted research on QRR-enhanced QAOA for Infineon use cases based on the job-shop scheduling problem, ran experiments on IQM quantum hardware.<br>
- Contributed to the QuaST Best Practice Guide on QRR algorithm and scheduling problem.<br>
3. Quantum Optimization Solver Kit (QuSol, BMBF funded project)&#58;<br>
- Building an optimization model of the current master planning system at Infineon.<br>
